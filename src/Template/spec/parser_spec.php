...
{
    public function should_match_basic_operators()
    {
    ...
    public function shuold_match_i18n_string()
    {
        expects(H2O_RE::$i18n_string)->should_match("_('hello world')");
    }

    public function should_match_variable_name()
    {
    ...
    public function should_match_named_arguments()
    {
    ...
    public function should_match_operators()
    {
        $operators = array('==', '>', '<', '>=', '<=', '!=');
...
{
    public function should_parse_named_arguments()
    {
