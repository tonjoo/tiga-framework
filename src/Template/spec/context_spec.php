...
{
    public function should_retrive_variable_using_array_interface()
    {
    ...
    public function should_set_variable_using_array_interface()
    {
        $c = create_context();
        $c['name'] = 'peter';
        $c['age'] = 18;
    ...
    public function should_ensure_scope_remain_local_in_a_stack_layer()
    {
...
{
    public function should_resolve_a_integer()
    {
        $c = create_context();
    ...
    public function should_resolve_a_float_number()
    {
        $c = create_context();
    ...
    public function should_resolve_a_negative_number()
    {
        $c = create_context();
    ...
    public function should_resolve_a_string()
    {
        $c = create_context();
...
{
    public function should_be_access_by_array_index()
    {
        $c = create_context(array(
    ...
    public function should_be_access_by_array_key()
    {
    ...
    public function should_resolve_array_like_objects()
    {
        $c = create_context(array(
    ...
    public function should_resolve_additional_array_property()
    {
        $c = create_context(array(
           'hobbies' => array('football', 'basket ball', 'swimming'),
       ));
...
{
    public function should_use_dot_to_access_object_property()
    {
        $c = create_context(array(
    ...
    public function should_return_null_for_undefined_or_private_object_property()
    {
        $c = create_context(array(
    ...
    public function should_use_dot_to_perform_method_call()
    {
        $c = create_context(array(
            'document' => new Document(
                'my business report',
    ...
    public function should_return_null_for_undefined_or_private_method_call()
    {
        $c = create_context(array(
            'document' => new Document(
                'my business report',
...
class Document
{
    public $h2o_safe = array('to_pdf', 'to_xml');
    private $uuid;
