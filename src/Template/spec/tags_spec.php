...
{
    public function should_evaluate_boolean_expression()
    {
...
{
    public function should_iterate_over_an_array_of_objects()
    {
    ...
    public function should_reverse_array_when_reversed_keyword_supplied()
    {
    ...
    public function should_only_iterable_over_limit_of_time_when_limit_keyword_supplied()
    {
    ...
    public function should_provide_variable_loop_in_for_block()
    {
