...
{
    public function should_display_text_content()
    {
...
{
    public function should_not_display_comments()
    {
        $person = 'taylor luk';
...
{
    public function should_render_name_in_a_h2o_context()
    {
        $abc = 'oh my god';
    ...
    public function should_apply_filter_if_available()
    {
        $name = 'taylor luk';
