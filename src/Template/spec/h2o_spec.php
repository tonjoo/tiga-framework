...
{
    public function should_be_able_to_create_from_string()
    {
...
{
    public function should_be_pre_registered_with_default_tags()
    {
    ...
    public function should_be_able_to_register_a_new_tag()
    {
...
class Describe_h2o_filter_registration extends SimpleSpec
{
    ...
    public function should_be_able_to_register_a_filter()
    {
